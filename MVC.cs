...
//Create DB : DB_Name(Create Table)
...
//4.Create a Folder in side the Model folder “ViewModel” and create a class
...
< section >
    ...
    < table class= "table text-center border-1" >
        < thead >
            < tr >
                < th >
                    @Html.DisplayNameFor(m => m.trainid)
                </ th >

                < th >
                    @Html.DisplayNameFor(m => m.trainname)
                </ th >
                < th >
        ...
        < tbody >
            @foreach(var t in Model)
            {
                < tr >
                    < td >
                        @Html.DisplayFor(m => t.trainid)
                    </ td >

                    < td >
                        @Html.DisplayFor(m => t.trainname)
                    </ td >
                    < td >
                        @Html.DisplayFor(m => t.startdate)
                    </ td >
                    < td >
                        @Html.DisplayFor(m => t.isactive)
                    </ td >
                    < td >
                        @Html.DisplayFor(m => t.capacity)
                    </ td >
                    < td >
                        < img src = "@t.picture" height = "80" width = "80" />
                    </ td >
                </ tr >
                < tr >
                    < td colspan = "6" >
